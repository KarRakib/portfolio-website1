...
const About = () => {
    return (
        <div className='py-7 py-7 md:w-[1200px] lg:w-[1600px] mx-auto  text-white '>
            ...
            <p className='text-start ml-3'> A Passionate MERN Stack Developer and dedicated to my work. I worked varies projects with modern technologies like javascript, react, node js, golang.
